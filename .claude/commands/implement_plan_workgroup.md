...
You are working with other agents. Check in with agent mail. If you are idle, poll every 20 seconds.

Use up to 5 Haiku subagents for all file ops (grep, glob, read)

Use up to 10 sonnet subagents for analysis and research and codewriting

Use an Opus subagent for planning and TLA+ modeling
