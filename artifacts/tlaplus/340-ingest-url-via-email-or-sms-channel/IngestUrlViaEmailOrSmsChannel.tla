---- MODULE IngestUrlViaEmailOrSmsChannel ----
EXTENDS Naturals, Sequences, FiniteSets

CONSTANTS mq_a1b2, mq_c3d4, api_e5f6, api_n8k2, db_h2s4, db_d3w8, db_l1c3, cfg_g7h8, cfg_r3d7
...
\* --- Error actions ---
Step1_Receive_inbound_message_Error ==
    /\ pc = "idle"
    /\ pc' = "error"
    /\ error_state' = TRUE
    /\ UNCHANGED << step_1_out, step_2_out, step_3_out, step_4_out, step_5_out >>

Step2_Resolve_sender_to_user_account_Error ==
    /\ pc = "step_1"
    /\ pc' = "error"
    /\ error_state' = TRUE
    /\ UNCHANGED << step_1_out, step_2_out, step_3_out, step_4_out, step_5_out >>

Step3_Extract_and_validate_URL_from_message_body_Error ==
    /\ pc = "step_2"
    /\ pc' = "error"
    /\ error_state' = TRUE
    /\ UNCHANGED << step_1_out, step_2_out, step_3_out, step_4_out, step_5_out >>

Step4_Feed_URL_into_standard_ingestion_pipeline_Error ==
    /\ pc = "step_3"
    /\ pc' = "error"
    /\ error_state' = TRUE
    /\ UNCHANGED << step_1_out, step_2_out, step_3_out, step_4_out, step_5_out >>

Step5_Notify_user_of_successful_ingestion_Error ==
    /\ pc = "step_4"
    /\ pc' = "error"
    /\ error_state' = TRUE
    /\ UNCHANGED << step_1_out, step_2_out, step_3_out, step_4_out, step_5_out >>
