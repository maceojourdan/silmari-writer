---- MODULE GenerateDraftFromConfirmedClaims ----
EXTENDS Naturals, Sequences, FiniteSets

CONSTANTS ui_w8p2, ui_a4y1, api_q7v1, api_m5g7, api_n8k2, db_h2s4, db_d3w8, db_f8n5, cfg_d2q3, db_l1c3, cfg_j9w2
...
Step2_Handle_draft_generation_endpoint_request_Error ==
    /\ pc = "step_1"
    /\ pc' = "error"
    /\ error_state' = TRUE
    /\ UNCHANGED << step_1_out, step_2_out, step_3_out, step_4_out, step_5_out >>

Step3_Retrieve_confirmed_claims_Error ==
    /\ pc = "step_2"
    /\ pc' = "error"
    /\ error_state' = TRUE
    /\ UNCHANGED << step_1_out, step_2_out, step_3_out, step_4_out, step_5_out >>

Step4_Transform_confirmed_claims_into_structured_draft_Error ==
    /\ pc = "step_3"
    /\ pc' = "error"
    /\ error_state' = TRUE
    /\ UNCHANGED << step_1_out, step_2_out, step_3_out, step_4_out, step_5_out >>

Step5_Persist_and_return_generated_draft_Error ==
    /\ pc = "step_4"
    /\ pc' = "error"
    /\ error_state' = TRUE
    /\ UNCHANGED << step_1_out, step_2_out, step_3_out, step_4_out, step_5_out >>
