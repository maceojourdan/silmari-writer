---- MODULE VoiceAdvanceRegression_TTrace_1772722954 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("VoiceAdvanceRegression_TTrace_1772722954.json", _TETrace)
...
\*
\*trace == IODeserialize("VoiceAdvanceRegression_TTrace_1772722954.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([connected |-> TRUE,uiIndex |-> 1,userSpoke |-> FALSE,pc |-> "listening",llmSpeaking |-> TRUE,advIndex |-> 0,llmIndex |-> 1,stopVisible |-> FALSE,upsertIndex |-> 0]),
    ([connected |-> FALSE,uiIndex |-> 1,userSpoke |-> FALSE,pc |-> "stop_presented",llmSpeaking |-> FALSE,advIndex |-> 0,llmIndex |-> -1,stopVisible |-> TRUE,upsertIndex |-> 0]),
    ([connected |-> FALSE,uiIndex |-> 0,userSpoke |-> FALSE,pc |-> "stop_presented",llmSpeaking |-> FALSE,advIndex |-> 0,llmIndex |-> -1,stopVisible |-> TRUE,upsertIndex |-> 0])
    >>
----
...
---- CONFIG VoiceAdvanceRegression_TTrace_1772722954 ----
CONSTANTS
    MAX_Q = 4
    FIX_RECORD = TRUE
    FIX_REPROMPT = TRUE
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 05 10:02:34 EST 2026