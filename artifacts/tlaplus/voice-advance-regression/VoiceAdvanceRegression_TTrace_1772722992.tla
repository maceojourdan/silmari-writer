---- MODULE VoiceAdvanceRegression_TTrace_1772722992 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("VoiceAdvanceRegression_TTrace_1772722992.json", _TETrace)
...
\*
\*trace == IODeserialize("VoiceAdvanceRegression_TTrace_1772722992.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([connected |-> TRUE,uiIndex |-> 1,userSpoke |-> FALSE,pc |-> "listening",llmSpeaking |-> TRUE,advIndex |-> 1,llmIndex |-> 1,stopVisible |-> FALSE,upsertIndex |-> 1]),
    ([connected |-> TRUE,uiIndex |-> 1,userSpoke |-> FALSE,pc |-> "stop_presented",llmSpeaking |-> TRUE,advIndex |-> 1,llmIndex |-> 1,stopVisible |-> TRUE,upsertIndex |-> 1]),
    ([connected |-> TRUE,uiIndex |-> 2,userSpoke |-> FALSE,pc |-> "listening",llmSpeaking |-> TRUE,advIndex |-> 2,llmIndex |-> 2,stopVisible |-> FALSE,upsertIndex |-> 2]),
    ([connected |-> TRUE,uiIndex |-> 2,userSpoke |-> FALSE,pc |-> "stop_presented",llmSpeaking |-> TRUE,advIndex |-> 2,llmIndex |-> 2,stopVisible |-> TRUE,upsertIndex |-> 2]),
    ([connected |-> TRUE,uiIndex |-> 3,userSpoke |-> FALSE,pc |-> "listening",llmSpeaking |-> TRUE,advIndex |-> 3,llmIndex |-> 3,stopVisible |-> FALSE,upsertIndex |-> 3]),
    ([connected |-> TRUE,uiIndex |-> 3,userSpoke |-> FALSE,pc |-> "stop_presented",llmSpeaking |-> TRUE,advIndex |-> 3,llmIndex |-> 3,stopVisible |-> TRUE,upsertIndex |-> 3]),
    ([connected |-> FALSE,uiIndex |-> 4,userSpoke |-> FALSE,pc |-> "all_complete",llmSpeaking |-> FALSE,advIndex |-> 4,llmIndex |-> -1,stopVisible |-> FALSE,upsertIndex |-> 3])
    >>
----
...
---- CONFIG VoiceAdvanceRegression_TTrace_1772722992 ----
CONSTANTS
    MAX_Q = 4
    FIX_RECORD = TRUE
    FIX_REPROMPT = TRUE
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 05 10:03:12 EST 2026