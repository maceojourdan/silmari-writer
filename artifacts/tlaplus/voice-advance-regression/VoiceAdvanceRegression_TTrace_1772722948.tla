---- MODULE VoiceAdvanceRegression_TTrace_1772722948 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("VoiceAdvanceRegression_TTrace_1772722948.json", _TETrace)
...
\*
\*trace == IODeserialize("VoiceAdvanceRegression_TTrace_1772722948.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG VoiceAdvanceRegression_TTrace_1772722948 ----
CONSTANTS
    MAX_Q = 4
    FIX_RECORD = TRUE
    FIX_REPROMPT = TRUE
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 05 10:02:29 EST 2026