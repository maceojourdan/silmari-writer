---- MODULE VoiceAdvanceRegression_TTrace_1772722855 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("VoiceAdvanceRegression_TTrace_1772722855.json", _TETrace)
...
\*
\*trace == IODeserialize("VoiceAdvanceRegression_TTrace_1772722855.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG VoiceAdvanceRegression_TTrace_1772722855 ----
CONSTANTS
    MAX_Q = 4
    FIX_RECORD = FALSE
    FIX_REPROMPT = FALSE
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 05 10:00:55 EST 2026