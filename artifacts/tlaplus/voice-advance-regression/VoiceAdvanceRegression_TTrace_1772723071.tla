---- MODULE VoiceAdvanceRegression_TTrace_1772723071 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("VoiceAdvanceRegression_TTrace_1772723071.json", _TETrace)
...
\*
\*trace == IODeserialize("VoiceAdvanceRegression_TTrace_1772723071.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG VoiceAdvanceRegression_TTrace_1772723071 ----
CONSTANTS
    MAX_Q = 4
    FIX_RECORD = FALSE
    FIX_REPROMPT = FALSE
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 05 10:04:31 EST 2026