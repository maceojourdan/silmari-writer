---- MODULE VoiceAdvanceRegression_TTrace_1772723094 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("VoiceAdvanceRegression_TTrace_1772723094.json", _TETrace)
...
\*
\*trace == IODeserialize("VoiceAdvanceRegression_TTrace_1772723094.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([connected |-> TRUE,uiIndex |-> 1,userSpoke |-> FALSE,pc |-> "listening",llmSpeaking |-> FALSE,advIndex |-> 1,llmIndex |-> 1,stopVisible |-> FALSE,upsertIndex |-> 1])
    >>
----
...
---- CONFIG VoiceAdvanceRegression_TTrace_1772723094 ----
CONSTANTS
    MAX_Q = 4
    FIX_RECORD = TRUE
    FIX_REPROMPT = FALSE
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 05 10:04:54 EST 2026