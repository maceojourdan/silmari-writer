---- MODULE VoiceAdvanceRegression_TTrace_1772722907 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("VoiceAdvanceRegression_TTrace_1772722907.json", _TETrace)
...
\*
\*trace == IODeserialize("VoiceAdvanceRegression_TTrace_1772722907.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([connected |-> TRUE,uiIndex |-> 0,userSpoke |-> FALSE,pc |-> "listening",llmSpeaking |-> TRUE,advIndex |-> 0,llmIndex |-> 1,stopVisible |-> FALSE,upsertIndex |-> 0])
    >>
----
...
---- CONFIG VoiceAdvanceRegression_TTrace_1772722907 ----
CONSTANTS
    MAX_Q = 4
    FIX_RECORD = TRUE
    FIX_REPROMPT = TRUE
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 05 10:01:48 EST 2026