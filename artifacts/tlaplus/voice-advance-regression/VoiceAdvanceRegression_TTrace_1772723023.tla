---- MODULE VoiceAdvanceRegression_TTrace_1772723023 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("VoiceAdvanceRegression_TTrace_1772723023.json", _TETrace)
...
\*
\*trace == IODeserialize("VoiceAdvanceRegression_TTrace_1772723023.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([connected |-> TRUE,uiIndex |-> 1,userSpoke |-> FALSE,pc |-> "listening",llmSpeaking |-> FALSE,advIndex |-> 1,llmIndex |-> 1,stopVisible |-> FALSE,upsertIndex |-> 0])
    >>
----
...
---- CONFIG VoiceAdvanceRegression_TTrace_1772723023 ----
CONSTANTS
    MAX_Q = 4
    FIX_RECORD = FALSE
    FIX_REPROMPT = FALSE
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 05 10:03:43 EST 2026