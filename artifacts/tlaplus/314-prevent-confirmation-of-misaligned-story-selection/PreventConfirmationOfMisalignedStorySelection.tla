---- MODULE PreventConfirmationOfMisalignedStorySelection ----
EXTENDS Naturals, Sequences, FiniteSets

CONSTANTS ui_v3n6, ui_w8p2, ui_a4y1, cfg_j9w2, cfg_r3d7
...
Step2_Perform_client_side_alignment_validation_Error ==
    /\ pc = "step_1"
    /\ pc' = "error"
    /\ error_state' = TRUE
    /\ UNCHANGED << step_1_out, step_2_out, step_3_out, step_4_out >>

Step3_Block_confirmation_on_misalignment_Error ==
    /\ pc = "step_2"
    /\ pc' = "error"
    /\ error_state' = TRUE
    /\ UNCHANGED << step_1_out, step_2_out, step_3_out, step_4_out >>

Step4_Render_validation_feedback_to_user_Error ==
    /\ pc = "step_3"
    /\ pc' = "error"
    /\ error_state' = TRUE
    /\ UNCHANGED << step_1_out, step_2_out, step_3_out, step_4_out >>
