---- MODULE ShortlistContactsContributionDiscovery ----
EXTENDS Naturals, Sequences, FiniteSets

CONSTANTS ui_m1n2, ui_o3p4, ui_q5r6, ui_s7t8, api_u9v1, api_w2x3, api_y4z5, db_h2s4, db_d3w8, db_l1c3, cfg_r3d7
...
\* --- Error actions ---
Step1_Generate_company_short_list_Error ==
    /\ pc = "idle"
    /\ pc' = "error"
    /\ error_state' = TRUE
    /\ UNCHANGED << step_1_out, step_2_out, step_3_out, step_4_out, step_5_out >>

Step2_Save_and_manage_short_list_Error ==
    /\ pc = "step_1"
    /\ pc' = "error"
    /\ error_state' = TRUE
    /\ UNCHANGED << step_1_out, step_2_out, step_3_out, step_4_out, step_5_out >>

Step3_Discover_contribution_areas_for_selected_company_Error ==
    /\ pc = "step_2"
    /\ pc' = "error"
    /\ error_state' = TRUE
    /\ UNCHANGED << step_1_out, step_2_out, step_3_out, step_4_out, step_5_out >>

Step4_Discover_relevant_contacts_at_selected_company_Error ==
    /\ pc = "step_3"
    /\ pc' = "error"
    /\ error_state' = TRUE
    /\ UNCHANGED << step_1_out, step_2_out, step_3_out, step_4_out, step_5_out >>

Step5_Generate_outreach_drafts_for_contacts_Error ==
    /\ pc = "step_4"
    /\ pc' = "error"
    /\ error_state' = TRUE
    /\ UNCHANGED << step_1_out, step_2_out, step_3_out, step_4_out, step_5_out >>
